...
/**
* Retrieves the image associated with a specified image tile of the layer.
*
 ...
 * image should exist in the local file system image cache. From whence the image came and how it is save to the
 * image cache is determined by this method.
 *
 * This method is called on a thread separate from the UI thread.
 *
 * If an error occurs retrieving or saving the image an error message is logged.
 *
