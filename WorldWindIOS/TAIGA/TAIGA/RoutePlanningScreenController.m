...
@implementation RoutePlanningScreenController
{
    CGRect myFrame;
...
- (void) createTopToolbar
{
    ...
    button1 = [[UIBarButtonItem alloc] initWithTitle:@"Flight Paths" style:UIBarButtonItemStylePlain
                                              target:self
                                              action:@selector(handleButtonTap)];
    [button1 setTitleTextAttributes:textAttrs forState:UIControlStateNormal];

    button2 = [[UIBarButtonItem alloc] initWithTitle:@"Overlays" style:UIBarButtonItemStylePlain
                                              target:self
                                              action:@selector(handleButtonTap)];
    [button2 setTitleTextAttributes:textAttrs forState:UIControlStateNormal];

    button3 = [[UIBarButtonItem alloc] initWithTitle:@"Split View" style:UIBarButtonItemStylePlain
                                              target:self
                                              action:@selector(handleButtonTap)];
    [button3 setTitleTextAttributes:textAttrs forState:UIControlStateNormal];

    button4 = [[UIBarButtonItem alloc] initWithTitle:@"Quick Views" style:UIBarButtonItemStylePlain
                                              target:self
                                              action:@selector(handleButtonTap)];
